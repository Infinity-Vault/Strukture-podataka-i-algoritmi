...
class PrioitetniRedSeq //pišemo klasu Prioritetni Red Sekvencijalno
{
  private: //u privatnom djelu klase stvaramo atribude trenutno, naš niz i veličina niza
	...
	{
		return sqrtf(powf(0 - niz[index].x, 2) + powf(0 - niz[index].y, 2)); //u zavisnosti od toga koja se tacka trazi ova se forula mjenja posto se trazi udaljenost od koordinatnog pocetka sada ovdje su fiksne vrije4dnosti 0 da se je npr. trazila udaljenost od tacke (5,5) onda  bi vrijednosti fiksne bile 5
	}
public:
